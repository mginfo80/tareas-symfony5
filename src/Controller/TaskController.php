...
class TaskController extends AbstractController
{
    ...
    public function index()
    {
        ...
        //listar las tareas
        //foreach($tasks as $task)    echo $task->getUser()->getEmail().": ".$task->getTitle()."<br/>";
/*
...
*/  
    ...
    public function edit(Request $request, UserInterface $user, Task $task){
        ...
        //valido que sea el propietario de la tarea
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $task->setUpdatedAt(new \Datetime('now'));  //fecha de actualizacion
        ...
        //muestro el formulario para editar la tarea
        return $this->render('task/creation.html.twig', [
            'edit'  => true,
            'form'  => $form->createView()
        ]);
